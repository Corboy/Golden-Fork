...
import { Minus, Plus, Trash2, MessageCircle, ShoppingBag, User, Phone, MapPin, Building, Clock, Check, ArrowRight, ArrowLeft, AlertCircle } from "lucide-react";
            ...
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-body font-semibold transition-all ${
                    currentStep === 1
                ...
                >
                  {form.fullName && form.phone ? <Check size={12} /> : <span>1</span>}
                  <span>Info</span>
                </button>
                ...
                >
                  {form.deliveryLocation ? <Check size={12} /> : <span>2</span>}
                  <span>Location</span>
                </button>
              ...
              <form onSubmit={goToStep2} className="space-y-4 animate-fade-in">
                <div>
                  ...
                  <p className="text-[11px] font-body text-muted-foreground mt-0.5">
                    We only need your name and WhatsApp number to get started.
                  </p>
                </div>
